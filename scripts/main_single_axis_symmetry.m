...
if non_uniform_distribution == 0
    filename = ...
        strcat('../results/symmetry/', image_name, '/', num2str(sigmaNoiseFraction*100), '_percent_noise/');
else
    filename = ...
        strcat('../results/symmetry/',  image_name, '/', num2str(sigmaNoiseFraction*100), '_percent_noise/non_uniform_distribution/');
end
